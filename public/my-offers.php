...
<head>
    ...
    <title>My Offers - Neptune Swap</title>
</head>
<body>
    ...
    <main>
        ...
        <section class="block-section market-section">
            <div class="register-name">
                <h2 class="block-title">My Offers</h2>
            </div>  
            <div class="shop-block" id="shop-block"></div>
            <div class="page-switcher">
                <button class="switch-page-button" id="prev-page" disabled><</button>
    ...
    <script src="scripts/loadMyOffers.js" defer></script>
</body>
</html>